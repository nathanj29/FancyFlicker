...
**Observation**: it may be possible you can move the right stick out of the **dotted line representing a mapping of the expected range of motion** _Journey_ considers for the sticks (depending on your controller, or how worn out the sticks are).
